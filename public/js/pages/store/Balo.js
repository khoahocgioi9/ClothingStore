...
selectSortBy.onchange = function () {
	window.location.href = `/src/pages/store/Balo.html?${this.name}=${this.value}`;
};

let pageIndex = 1;
const numberOfProductsPerPage = 2;
const typeOfProduct = 3;
...
const listProductShirt = document.getElementById('list-product-balo');
const loadingAnimation = document.getElementById('loading-animation');
const showMoreBtn = document.getElementById('show_more_btn');
async function loadMoreProductsBalo() {
